...
export default async function SubAdminRejectedPage() {
  ...
  return (
    <div className="mx-auto max-w-md py-16 text-center">
      <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-red-50 dark:bg-red-950/30 border border-red-100 dark:border-red-800">
        <ShieldX className="h-5 w-5 text-red-500 dark:text-red-400" />
      </div>
      <h2 className="font-heading text-xl text-foreground">Access Rejected</h2>
