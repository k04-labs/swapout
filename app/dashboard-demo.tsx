    ...
    <>
      ...
      >
        ...
        <div className="border-t border-slate-200/80 p-3">
          <div className="flex items-center gap-2.5 rounded-lg p-2 hover:bg-slate-50 cursor-pointer group">
  ...
  return (
    <header className="flex h-14 shrink-0 items-center justify-between border-b border-slate-200/80 bg-white px-4 lg:px-6">
      <div className="flex items-center gap-3">
        ...
        <div className="hidden sm:flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3 py-1.5 w-52">
...
function StatCard({ stat }: { stat: (typeof STATS)[0] }) {
  return (
    <div className="rounded-xl border border-slate-200/80 bg-white p-4 hover:shadow-sm transition-shadow">
      ...
      <div className="flex flex-1 flex-col min-w-0 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto px-4 py-5 lg:px-6 lg:py-6 space-y-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <button className="hidden sm:flex items-center gap-1.5 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs font-medium text-slate-600 hover:bg-slate-50 transition-colors shadow-xs">
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
            ...
            <div className="flex flex-col gap-4">
              ...
              {/* Activity feed */}
              <div className="flex-1 rounded-xl border border-slate-200/80 bg-white overflow-hidden">
